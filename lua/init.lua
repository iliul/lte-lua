...
--
-- $Id: template-init.lua 47885 2013-02-25 22:05:28Z mmann $
--
...
dofile(DATA_DIR.."cdr_x2.lua")

dofile(DATA_DIR.."cdr_uu.lua")

dofile(DATA_DIR.."cdr_s6a.lua")

dofile(DATA_DIR.."cdr_s1_mme.lua")


dofile(DATA_DIR.."sdr.lua")

dofile(DATA_DIR.."sdr_cdr.lua")

dofile(DATA_DIR.."cmcc_udp.lua")
